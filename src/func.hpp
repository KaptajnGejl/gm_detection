...
corner find_square(vector<corner> corners,Mat& img_cor,Mat& img_thr, float limit); 
corner find_triangle(vector<corner> corners,Mat& img_cor, Mat& img_thr, float limit); 
